...
const { database_shop } = require('./keys'); // Traemos el objeto database_shop de los exports de keys.

const pool = mysql.createPool(database_shop); // Creamos un pool y lo guardamos en [pool].
...
pool.getConnection((err, connection) => {
    ...
    console.log(`Base de datos '${database_shop.database}' conectada.`);
});
